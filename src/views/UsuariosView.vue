...
<style scoped>
.page-head { display:flex; align-items:center; justify-content:space-between; gap:1rem; flex-wrap:wrap; background:linear-gradient(135deg,#14213d 0%,#1e3a62 100%); border:none; border-radius:1rem; padding:1.5rem 1.75rem; box-shadow:0 8px 24px rgba(15,23,42,0.18); }
.page-head-left { display:flex; align-items:center; gap:1rem; }
.page-icon  { width:2.75rem; height:2.75rem; min-width:2.75rem; background:rgba(255,255,255,0.15); border:1px solid rgba(255,255,255,0.2); border-radius:0.65rem; display:grid; place-items:center; color:#fff; font-size:1rem; }
.page-title { font-family:var(--font-display); font-size:1.15rem; font-weight:700; margin:0 0 0.2rem; color:#fff; }
.page-sub   { font-size:0.8rem; color:rgba(255,255,255,0.65); margin:0; }
.btn-add { display:flex; align-items:center; gap:0.4rem; padding:0.6rem 1.2rem; background:rgba(255,255,255,0.15); color:#fff; border:1px solid rgba(255,255,255,0.25); border-radius:0.65rem; font-size:0.85rem; font-weight:600; cursor:pointer; transition:background 0.14s; white-space:nowrap; }
.btn-add:hover { background:rgba(255,255,255,0.25); }

.state-error   { background:rgba(196,69,54,0.07); border:1px solid rgba(196,69,54,0.2); border-radius:0.75rem; padding:1rem 1.25rem; color:var(--danger); font-size:0.85rem; }
.state-loading { text-align:center; padding:3rem; color:var(--ink-500); font-size:0.9rem; }

.table-card { background:var(--paper); border:1px solid var(--line); border-radius:1rem; overflow:hidden; box-shadow:var(--shadow-sm); }
